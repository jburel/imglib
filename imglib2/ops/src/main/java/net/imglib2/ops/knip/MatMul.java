...
public class MatMul< T extends RealType< T > & NativeType< T >> implements BinaryOutputOperation< RandomAccessibleInterval< T >, RandomAccessibleInterval< T >, Img< T >>
{
	 ...
	 */
	@Override
	public Img< T > createEmptyOutput( RandomAccessibleInterval< T > op0, RandomAccessibleInterval< T > op1 )
	{
		checkContraints( op0, op1 );
		Img< T > res = new ArrayImgFactory< T >().create( new long[] { op0.dimension( 0 ), op1.dimension( 1 ) }, op1.randomAccess().get().createVariable() );
		return res;
	}
	 ...
	 */
	@Override
	public Img< T > compute( RandomAccessibleInterval< T > op0, RandomAccessibleInterval< T > op1, Img< T > r )
	{
		checkContraints( op0, op1 );
	...
	{
		if ( op0.numDimensions() != 2 || op1.numDimensions() != 2 ) { throw new IllegalArgumentException( "Matrix multiplication only suitable for 2D images." ); }
		if ( op0.dimension( 1 ) != op1.dimension( 0 ) ) { throw new IllegalArgumentException( "Dimensions of images doesn't fit for matrix multiplication: img1.dimY != img2.dimX" ); }
	}
	...
	public Img< T > compute( RandomAccessibleInterval< T > op0, RandomAccessibleInterval< T > op1 )
	{
