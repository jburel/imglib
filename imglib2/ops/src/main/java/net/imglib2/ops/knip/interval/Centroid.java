...
public final class Centroid implements UnaryOutputOperation< IterableInterval< ? extends Type< ? >>, double[] >
{

	@Override
	public final double[] compute( final IterableInterval< ? extends Type< ? >> op, final double[] r )
	{

		if ( r.length != op.numDimensions() ) { throw new IllegalArgumentException( "Number of dimensions in result array do not fit (Centroid)" ); }
