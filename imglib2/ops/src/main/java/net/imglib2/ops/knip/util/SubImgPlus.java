...
public class SubImgPlus< T extends Type< T >> extends ImgPlus< T >
{
	 ...
	 * @TODO: Metadata erweitern
	 */
	public SubImgPlus( ImgPlus< T > srcImg, Interval interval, boolean keepDimsWithSizeOne )
	{
		super( new SubImg< T >( srcImg, interval, keepDimsWithSizeOne ), srcImg );
