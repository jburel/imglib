 ...
 */
public class Rotate2D< T extends Type< T > & Comparable< T >> implements UnaryOutputOperation< Img< T >, Img< T >>
{
	 ...
	 *            will be used
	 */
	public Rotate2D( double angle, int dimIdx1, int dimIdx2, boolean keepSize, T outOfBoundsType, long[] center )
	{
		m_angle = angle;
		m_dimIdx1 = dimIdx1;
		m_dimIdx2 = dimIdx2;
	...
	{
		return new Rotate2D< T >( m_angle, m_dimIdx1, m_dimIdx2, m_keepSize, m_outOfBoundsType, m_center );
	}
